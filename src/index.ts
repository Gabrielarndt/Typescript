...
type tipoGeral = { nome: string, preço: number, categoria: CategoriaComida }[]
...
import{somar, subtrair, dividir, multiplicar} from './aula2.js'
...
import {geometria} from './aula2.js'
let circulo = new geometria.circulo(12)
let retangulo = new geometria.retangulo(35,43)
